class PhotographerCard {
    ...
    createHeaderPhotographerCard() {
        ...
        const getUserPage =
            ...
            <div class="button">
                <button type="button" aria-label="Ouvrir" title="Ouvrir cette fenêtre modale" data-dimiss="dialog" class="contact_button" onclick="displayModal()">Contactez-moi</button>
            </div>
            <div class="photo">
